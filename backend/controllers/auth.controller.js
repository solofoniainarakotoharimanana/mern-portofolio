...
export const forgotPassword = async (req, res) => {
    ...
    try {
        ...
        //send email
        sendEmail("solofoniainarakotoharimanana@gmail", "resetPassword", "", "", `${process.env.CLIENT_URL}/reset-password/${resetToken}`);
...
export const resetPassword = async (req, res) => {
    try {
        ...
        //send email
        sendEmail("solofoniainarakotoharimanana@gmail", "resetSuccessEmail", "", "", "");
